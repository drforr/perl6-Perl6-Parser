...
subtest {
	subtest {
		subtest {
			subtest {
				ok Perl6::Operator::Hyper ~~ Perl6::Operator,
			...
			subtest {
				ok Perl6::Operator::Prefix ~~ Perl6::Operator,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Operator ), Q{found};
			...
			subtest {
				ok Perl6::Operator::Infix ~~ Perl6::Operator,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Operator ), Q{found};
			...
			subtest {
				ok Perl6::Operator::Postfix ~~ Perl6::Operator,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Operator ), Q{found};
			...
			subtest {
				ok Perl6::Operator::PostCircumfix ~~
					Perl6::Operator,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Operator ), Q{found};
		...
		subtest {
			subtest {
				ok Perl6::String::Body ~~ Perl6::String,
					Q{has correct parent};
				ok has-a( $tree, Perl6::String::Body ),
					Q{found};
			...
			subtest {
				ok Perl6::String::WordQuoting ~~ Perl6::String,
					Q{has correct parent};
				ok has-a( $tree, Perl6::String::WordQuoting ),
					Q{found};
			...
			subtest {
				ok Perl6::String::Interpolation ~~
					Perl6::String,
					Q{has correct parent};
				ok has-a( $tree, Perl6::String::Interpolation ),
					Q{found};
				...
				subtest {
					...
					subtest {
						ok Perl6::String::Interpolation::WordQuoting::QuoteProtection ~~
							...
							Q{has correct parent};
						ok has-a( $tree, Perl6::String::Interpolation::WordQuoting::QuoteProtection ),
							Q{found};
			...
			subtest {
				ok Perl6::String::Shell ~~ Perl6::String,
					Q{has correct parent};
				ok has-a( $tree, Perl6::String::Shell ),
					Q{found};
			...
			subtest {
				ok Perl6::String::Escaping ~~ Perl6::String,
					Q{has correct parent};
				ok has-a( $tree, Perl6::String::Escaping ),
					Q{found};
			...
			subtest {
				ok Perl6::String::Literal ~~ Perl6::String,
					Q{has correct parent};
				ok has-a( $tree, Perl6::String::Literal ),
					Q{found};
				...
				subtest {
					ok Perl6::String::Literal::Shell ~~ Perl6::String,
						Q{has correct parent};
					ok has-a( $tree, Perl6::String::Literal::Shell ),
						Q{found};
		...
		subtest {
			...
			subtest {
				ok Perl6::Balanced::Enter ~~ Perl6::Balanced,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Balanced::Enter ),
					Q{found};

				subtest {
					ok Perl6::Block::Enter ~~
						Perl6::Balanced::Enter,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Block::Enter ),
						Q{found};
				...
				subtest {
					ok Perl6::String::Enter ~~
						Perl6::Balanced::Enter,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::String::Enter ),
						Q{found};
}
			...
			subtest {
				ok Perl6::Balanced::Exit ~~ Perl6::Balanced,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Balanced::Exit ),
					Q{found};
				...
				subtest {
					ok Perl6::Block::Exit ~~
						Perl6::Balanced::Exit,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Block::Exit ),
						Q{found};
				...
				subtest {
					ok Perl6::String::Exit ~~
						Perl6::Balanced::Exit,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::String::Exit ),
						Q{found};
}
...
#`{
		...
		subtest {
			ok Perl6::Loop-Separator ~~ Perl6::Visible,
				Q{has correct parent};
#`{
		...
		subtest {
			ok Perl6::Dimension-Separator ~~ Perl6::Visible,
				Q{has correct parent};
#`{
			ok has-a( $tree, Perl6::Dimension-Separator ),
				Q{found};
}
...
#`{
		...
		subtest {
#			ok Perl6::Sir-Not-Appearing-In-This-Document ~~
#				Perl6::Visible,
#				Q{has correct parent};
#			ok has-a( $tree,
#				Perl6::Sir-Not-Appearing-In-This-Document ),
#				Q{found};
#
			done-testing;
		...
		subtest {
			...
			subtest {
				ok Perl6::Number::Binary ~~ Perl6::Number,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Number::Binary ),
					Q{found};
			...
			subtest {
				ok Perl6::Number::Octal ~~ Perl6::Number,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Number::Octal ),
					Q{found};
			...
			subtest {
				ok Perl6::Number::Decimal ~~ Perl6::Number,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Number::Decimal ),
					Q{found};
...
#`{
			...
			subtest {
				ok Perl6::Number::Hexadecimal ~~ Perl6::Number,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Number::Hexadecimal ),
					Q{found};
			...
			subtest {
				ok Perl6::Number::Radix ~~ Perl6::Number,
					Q{has correct parent};
#`{
				ok has-a( $tree, Perl6::Number::Radix ),
					Q{found};
}
			...
			subtest {
				ok Perl6::Number::FloatingPoint ~~
					Perl6::Number,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Number::FloatingPoint ),
					Q{found};
		...
		subtest {
			...
			subtest {
				ok Perl6::SubroutineDeclaration ~~
					Perl6::Bareword,
					Q{has correct parent};
#`{
				ok has-a( $tree, Perl6::SubroutineDeclaration ),
					Q{found};
}
			...
			subtest {
				ok Perl6::ColonBareword ~~
					Perl6::Bareword,
					Q{has correct parent};
				ok has-a( $tree, Perl6::ColonBareword ),
					Q{found};
...
#`{
		...
		subtest {
			ok Perl6::Variable ~~ Perl6::Visible,
				Q{has correct parent};
			ok has-a( $tree, Perl6::Variable ),
				Q{found};

			subtest {
				ok Perl6::Variable::Scalar ~~ Perl6::Variable,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Variable::Scalar ),
					Q{found};
				...
				subtest {
					ok Perl6::Variable::Scalar::Contextualizer ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::Variable::Scalar::Contextualizer ),
						Q{found};
}
				...
				subtest {
					ok Perl6::Variable::Scalar::Dynamic ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Scalar::Dynamic ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Scalar::Attribute ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Scalar::Attribute ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Scalar::Accessor ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Scalar::Accessor ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Scalar::CompileTime ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::Variable::Scalar::CompileTime ),
						Q{found};
}
				...
				subtest {
					ok Perl6::Variable::Scalar::MatchIndex ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::Variable::Scalar::MatchIndex ),
						Q{found};
}
				...
				subtest {
					ok Perl6::Variable::Scalar::Positional ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::Variable::Scalar::Positional ),
						Q{found};
}
...
#`{
				...
				subtest {
					ok Perl6::Variable::Scalar::SubLanguage ~~ Perl6::Variable::Scalar,
						Q{has correct parent};
#`{
					ok has-a( $tree, Perl6::Variable::Scalar::SubLanguage ),
						Q{found};
}
			...
			subtest {
				ok Perl6::Variable::Array ~~ Perl6::Variable,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Variable::Array ),
					Q{found};

#				subtest {
#					ok Perl6::Variable::Array::Contextualizer ~~ Perl6::Variable::Array,
#						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Array::Contextualizer ),
#						Q{found};
#
#					done-testing;
...
#`{
				...
				subtest {
					ok Perl6::Variable::Array::Accessor ~~ Perl6::Variable::Array,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Array::Accessor ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Array::CompileTime ~~ Perl6::Variable::Array,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Array::CompileTime ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Array::MatchIndex ~~ Perl6::Variable::Array,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Array::MatchIndex ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Array::Positional ~~ Perl6::Variable::Array,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Array::Positional ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Array::Named ~~ Perl6::Variable::Array,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Array::Named ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Array::Pod ~~ Perl6::Variable::Array,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Array::Pod ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Array::SubLanguage ~~ Perl6::Variable::Array,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Array::SubLanguage ),
#						Q{found};
			...
			subtest {
				ok Perl6::Variable::Hash ~~ Perl6::Variable,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Variable::Hash ),
					Q{found};

#				subtest {
#					ok Perl6::Variable::Hash::Contextualizer ~~ Perl6::Variable::Hash,
#						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::Contextualizer ),
#						Q{found};
#
#					done-testing;
#				}, Q{Variable::Hash::Contextualizer};
				...
				subtest {
					ok Perl6::Variable::Hash::Dynamic ~~ Perl6::Variable::Hash,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Hash::Dynamic ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::Attribute ~~ Perl6::Variable::Hash,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::Attribute ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::Accessor ~~ Perl6::Variable::Hash,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Hash::Accessor ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::CompileTime ~~ Perl6::Variable::Hash,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::CompileTime ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::MatchIndex ~~ Perl6::Variable::Hash,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::MatchIndex ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::Positional ~~ Perl6::Variable::Hash,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::Positional ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::Named ~~ Perl6::Variable::Hash,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::Named ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::Pod ~~ Perl6::Variable::Hash,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Hash::Pod ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Hash::SubLanguage ~~ Perl6::Variable::Hash,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Hash::SubLanguage ),
#						Q{found};
			...
			subtest {
				ok Perl6::Variable::Callable ~~ Perl6::Variable,
					Q{has correct parent};
				ok has-a( $tree, Perl6::Variable::Callable ),
					Q{found};
...
#				}, Q{Variable::Callable::Contextualizer};
				...
				subtest {
					ok Perl6::Variable::Callable::Dynamic ~~ Perl6::Variable::Callable,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Callable::Dynamic ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::Attribute ~~ Perl6::Variable::Callable,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Callable::Attribute ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::Accessor ~~ Perl6::Variable::Callable,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Callable::Accessor ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::CompileTime ~~ Perl6::Variable::Callable,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Callable::CompileTime ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::MatchIndex ~~ Perl6::Variable::Callable,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Callable::MatchIndex ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::Positional ~~ Perl6::Variable::Callable,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Callable::Positional ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::Named ~~ Perl6::Variable::Callable,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Callable::Named ),
#						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::Pod ~~ Perl6::Variable::Callable,
						Q{has correct parent};
					ok has-a( $tree, Perl6::Variable::Callable::Pod ),
						Q{found};
				...
				subtest {
					ok Perl6::Variable::Callable::SubLanguage ~~ Perl6::Variable::Callable,
						Q{has correct parent};
#					ok has-a( $tree, Perl6::Variable::Callable::SubLanguage ),
#						Q{found};
